...
export class ViewCustomerService implements Resolve<any>
{
    ...
    {        
        return new Promise((resolve, reject) => {
            ...
            {
                this._httpClient.get(this.apiBaseURL + 'customer/GetCustomer/' + this.routeParams.id, httpOptions)
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post('api/in-memory-customers/' + customer.id, customer)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post('api/in-memory-customers/', customer)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    {        
        return new Promise((resolve, reject) => {
                ...
                this._httpClient.get(this.apiBaseURL + 'customer/GetBindableDataSources', httpOptions)
                    .subscribe((response: any) => {
